...
namespace API.Controllers
{
    ...
    public class ProductController : BaseApiController
    {
        ...
        {
            var product = await _context.Products.Include(p => p.Supplier).Include(c => c.Category).FirstOrDefaultAsync(p => p.Id == id);
        ...
        public async Task<ActionResult<Product>> CreateProduct(Product product)
        {
            ...
            var cat = await _context.Category.FindAsync(product.Category.Id);
        ...
        public async Task<IActionResult> UpdateProduct(Guid id, Product product)
        {
            ...
            {
                var existingCategory = await _context.Category.FindAsync(product.Category.Id);
